...
import { createOctobotWappTools } from './core'
...
class OctobotWapp_Tools implements INode {
    ...
    constructor() {
        this.label = 'OctobotWapp'
        this.name = 'OctobotWapp'
        this.version = 2.0
        this.type = 'OctobotWapp'
        this.icon = 'OctobotWapp.svg'
        this.category = 'Tools'
        this.description = 'Send WhatsApp messages, check numbers, and manage labels via OctobotWapp API'
        ...
        this.inputs = [
            {
                ...
                name: 'actionType',
                type: 'options',
                description: 'Category of OctobotWapp operations',
                options: [
                    {
                        label: 'Messaging',
                        name: 'messaging'
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const tools = createOctobotWappTools({
            actions,
            deviceUuid,
            apiToken,
            defaultRecipients
