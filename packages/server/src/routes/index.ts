...
router.use(
  "/datasets",
  IdentityManager.checkFeatureByPlan("feat:datasets"),
  datasetRouter
);
router.use("/document-store", documentStoreRouter);
router.use(
  "/evaluations",
  IdentityManager.checkFeatureByPlan("feat:evaluations"),
  evaluationsRouter
);
router.use(
  "/evaluators",
  IdentityManager.checkFeatureByPlan("feat:evaluators"),
  evaluatorsRouter
);
...
router.use(
  ...
  openaiAssistantsVectorStoreRouter
);
...
router.use(
  "/logs",
  IdentityManager.checkFeatureByPlan("feat:logs"),
  logsRouter
);
router.use(
  "/files",
  IdentityManager.checkFeatureByPlan("feat:files"),
  filesRouter
);
