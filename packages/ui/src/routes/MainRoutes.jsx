...
const OpenAIAssistantLayout = Loadable(
  lazy(() => import("@/views/assistants/openai/OpenAIAssistantLayout"))
);
const CustomAssistantLayout = Loadable(
  lazy(() => import("@/views/assistants/custom/CustomAssistantLayout"))
);
const CustomAssistantConfigurePreview = Loadable(
  lazy(() =>
    import("@/views/assistants/custom/CustomAssistantConfigurePreview")
  )
);
...
const DocumentStoreDetail = Loadable(
  lazy(() => import("@/views/docstore/DocumentStoreDetail"))
);
const ShowStoredChunks = Loadable(
  lazy(() => import("@/views/docstore/ShowStoredChunks"))
);
const LoaderConfigPreviewChunks = Loadable(
  lazy(() => import("@/views/docstore/LoaderConfigPreviewChunks"))
);
const VectorStoreConfigure = Loadable(
  lazy(() => import("@/views/docstore/VectorStoreConfigure"))
);
const VectorStoreQuery = Loadable(
  lazy(() => import("@/views/docstore/VectorStoreQuery"))
);

// Evaluations routing
const EvalEvaluation = Loadable(
  lazy(() => import("@/views/evaluations/index"))
);
const EvaluationResult = Loadable(
  lazy(() => import("@/views/evaluations/EvaluationResult"))
);
const EvalDatasetRows = Loadable(
  lazy(() => import("@/views/datasets/DatasetItems"))
);
...
const SupervisorMonitor = Loadable(
  lazy(() => import("@/views/supervisor-monitor"))
);

// follow-ups routing
const FollowUps = Loadable(lazy(() => import("@/views/followups")));

// enterprise features
const UsersPage = Loadable(lazy(() => import("@/views/users")));
const RolesPage = Loadable(lazy(() => import("@/views/roles")));
const LoginActivityPage = Loadable(
  lazy(() => import("@/views/auth/loginActivity"))
);
const Workspaces = Loadable(lazy(() => import("@/views/workspace")));
const WorkspaceDetails = Loadable(
  lazy(() => import("@/views/workspace/WorkspaceUsers"))
);
