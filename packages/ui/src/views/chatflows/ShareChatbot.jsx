    ...
    return (
        <>
            ...
            <Card sx={{ borderColor: theme.palette.primary[200] + 75, p: 3, mt: 2 }} variant='outlined'>
                ...
                {textField(title, 'title', 'Title', 'string', 'OctoBot Assistant')}
                {textField(titleAvatarSrc, 'titleAvatarSrc', 'Title Avatar Link', 'string', `https://octobot.sirv.com/robot1.png`)}
